<?php
   ...
   $crud = new Crud();
   session_start();
   if(isset($_SESSION['type']) && $_SESSION['type']==3 && $_SESSION['id']){
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?t=index">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.php?t=index">
      ...
      <li class="nav-item">
        ...
        <div id="managementStudent" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="index.php?t=teacherprofile">View Profile</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="managementStatus" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="index.php?t=attendence">Attendance</a>
          </div>
        </div>
      </li>
        ...
        <div class="col-sm-12">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class=" mb-0 text-gray-800">
              <?php
                  echo "Teacher Name: ".$_SESSION['name'];
              ?>
            </h4>
