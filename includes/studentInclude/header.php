<?php
   ...
   session_start();
   if(isset($_SESSION['type']) && $_SESSION['type']==2 && $_SESSION['id'] && $_SESSION['admission_id']){
     $crud = new Crud();
 ?>
      ...
      <li class="nav-item">
        ...
        <div id="manageClass" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="index.php?st=buttons">Class Routine</a>
            <a class="collapse-item" href="index.php?st=cards">Syllabus</a>
            <a class="collapse-item" href="index.php?st=cards">Class Lectures</a>
      ...
      <li class="nav-item">
        ...
        <div id="manageAccount" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?st=ledger">Student Ledger</a>
          </div>
        </div>
      </li>
