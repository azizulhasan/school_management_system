    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#manageUser" aria-expanded="true" aria-controls="manageUser">
          ...
          <span>Manage Administrations</span>
        </a>
      ...
      <li class="nav-item">
        ...
        <div id="managementStudent" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?s=stdportal">Create Portal</a>
            <a class="collapse-item" href="index.php?s=studentinfo">View Students</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="managementStatus" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="index.php?s=teacherregistration">Register</a>
            <a class="collapse-item" href="index.php?s=viewteacher">View Teachers</a>
      ...
      <li class="nav-item">
        ...
        <div id="manageClass" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          	<a class="collapse-item" href="index.php?s=managesubject">Manage Subjects</a>
      ...
      <li class="nav-item">
        ...
        <div id="manageExam" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?s=buttons">2nd Semester</a>
            <a class="collapse-item" href="index.php?s=buttons">3rd Semester</a>
            <a class="collapse-item" href="index.php?s=buttons">Montly Exam</a>
            <a class="collapse-item" href="index.php?s=cards">Assingment</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="index.php?s=resultddd">Manage Results</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="manageAccount" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?s=feetype">Tution Fees</a>
            <a class="collapse-item" href="index.php?s=addtutionfee">Create Students Payment</a>
          </div>
        </div>
      </li>
