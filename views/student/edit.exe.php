      ...
      <form action="" method="post">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="email" value="<?php echo "{$data['email']}"; ?>" name="email" class="form-control" id="studentEmail" placeholder="Student/Parent Email">
          </div>
          <div class="form-group col-md-6">
            <label for="studentPassword">Phone number</label>
            <input type="number" value="<?php echo "{$data['phone']}"; ?>" name="phone" class="form-control" id="studentPassword" placeholder="Password">
          </div>
        </div>
        <hr/>
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <input type="text" value="<?php echo "{$data['adminssion_class']}"; ?>" name="adminssion_class" class="form-control" id="studentId" placeholder="ID No">
          </div>
          <div class="form-group col-md-3">
  ...
  <div class="container pb-4">
    <form action="" method="post">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          <label for="studentEmail">Email</label>
          <input type="email" value="<?php echo $_POST['eamil']; ?>" name="email" class="form-control" id="studentEmail" placeholder="Student/Parent Email">
        </div>
        <div class="form-group col-md-4">
